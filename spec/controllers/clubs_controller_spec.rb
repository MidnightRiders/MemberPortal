...
describe ClubsController do
  ...
  skip 'GET show' do
    it 'assigns the requested club as @club' do
      club = Club.create! valid_attributes
      get :show, id: club.to_param, headers: valid_session
  ...
  skip 'GET edit' do
    it 'assigns the requested club as @club' do
      club = Club.create! valid_attributes
      get :edit, id: club.to_param, headers: valid_session
      expect(assigns(:club)).to eq(club)
    end
  end
  ...
  skip 'POST create' do
    skip 'with valid params' do
      it 'creates a new Club' do
        expect {
          post :create, club: valid_attributes, headers: valid_session
    ...
    skip 'with invalid params' do
      it 'assigns a newly created but unsaved club as @club' do
        ...
        post :create, club: { name: 'invalid value' }, headers: valid_session
        expect(assigns(:club)).to be_a_new(Club)
      end
  ...
  skip 'PUT update' do
    skip 'with valid params' do
      it 'updates the requested club' do
        ...
        put :update, id: club.to_param, club: { name: 'MyString' }, headers: valid_session
      end

      it 'assigns the requested club as @club' do
        club = Club.create! valid_attributes
        put :update, id: club.to_param, club: valid_attributes, headers: valid_session
        expect(assigns(:club)).to eq(club)
      end
    ...
    skip 'with invalid params' do
      it 'assigns the club as @club' do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Club.any_instance.stub(:save).and_return(false)
        put :update, id: club.to_param, club: { name: 'invalid value' }, headers: valid_session
        expect(assigns(:club)).to eq(club)
      end
  ...
  skip 'DELETE destroy' do
    it 'destroys the requested club' do
      club = Club.create! valid_attributes
      expect {
        delete :destroy, id: club.to_param, headers: valid_session
      }.to change(Club, :count).by(-1)
    end
