...
ActiveRecord::Schema.define(version: 20161218053236) do
  ...
  add_index "api_v1_sessions", ["auth_token"], name: "index_api_v1_sessions_on_auth_token", using: :btree
  add_index "api_v1_sessions", ["user_id"], name: "index_api_v1_sessions_on_user_id", using: :btree
  ...
  add_foreign_key "api_v1_sessions", "users"
end
