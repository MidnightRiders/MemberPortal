      ...
      self.S('.has-dropdown>a', section).each(function () {
        ...
        if (!$dropdown.find('.title.back').length) {
          if (settings.mobile_show_parent_link == true && url) {
            $titleLi = $(
              '<li class="title back js-generated"><Heading as="h5"><a href="javascript:void(0)"></a></Heading></li><li class="parent-link hide-for-medium-up"><a class="parent-link js-generated" href="' +
                url +
                '">' +
                $link.html() +
                '</a></li>',
            ...
            $titleLi = $(
              '<li class="title back js-generated"><Heading as="h5"><a href="javascript:void(0)"></a></Heading>',
            );
          }
